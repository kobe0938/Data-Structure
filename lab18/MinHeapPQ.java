...
public class MinHeapPQ<T> implements PriorityQueue<T> {
    ...
    public void insert(T item, double priorityValue) {
        // TODO: YOUR CODE HERE
        PriorityItem insertingPriorityItem = new PriorityItem(item, priorityValue);
        heap.insert(insertingPriorityItem);
    }
    ...
    public void changePriority(T item, double priorityValue) {
        // TODO: YOUR CODE HERE
        PriorityItem changingPriorityItem = new PriorityItem(item, priorityValue);
        heap.update(changingPriorityItem);
    }
